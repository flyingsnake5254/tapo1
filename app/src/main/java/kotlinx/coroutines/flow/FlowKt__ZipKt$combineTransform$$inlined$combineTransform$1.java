...
public final class FlowKt__ZipKt$combineTransform$$inlined$combineTransform$1 extends SuspendLambda implements p<b<? super R>, c<? super kotlin.p>, Object> {
    ...
    public FlowKt__ZipKt$combineTransform$$inlined$combineTransform$1(a[] aVarArr, c cVar, s sVar) {
        super(2, cVar);
        this.$flows = aVarArr;
    ...
    public final Object invoke(Object obj, c<? super kotlin.p> cVar) {
        return ((FlowKt__ZipKt$combineTransform$$inlined$combineTransform$1) create(obj, cVar)).invokeSuspend(kotlin.p.a);
    }
