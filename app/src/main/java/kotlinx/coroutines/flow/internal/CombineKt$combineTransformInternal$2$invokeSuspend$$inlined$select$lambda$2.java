...
public final class CombineKt$combineTransformInternal$2$invokeSuspend$$inlined$select$lambda$2 extends SuspendLambda implements p<Object, c<? super kotlin.p>, Object> {
    ...
    public CombineKt$combineTransformInternal$2$invokeSuspend$$inlined$select$lambda$2(p pVar, c cVar, c cVar2, Ref$BooleanRef ref$BooleanRef, r rVar, Ref$ObjectRef ref$ObjectRef, Ref$ObjectRef ref$ObjectRef2, Ref$BooleanRef ref$BooleanRef2, r rVar2) {
        super(2, cVar);
        this.$onReceive = pVar;
    ...
    public final Object invoke(Object obj, c<? super kotlin.p> cVar) {
        return ((CombineKt$combineTransformInternal$2$invokeSuspend$$inlined$select$lambda$2) create(obj, cVar)).invokeSuspend(kotlin.p.a);
    }
