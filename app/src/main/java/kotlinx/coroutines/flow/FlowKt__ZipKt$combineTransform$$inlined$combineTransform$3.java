...
@d(c = "kotlinx.coroutines.flow.FlowKt__ZipKt$combineTransform$$inlined$combineTransform$3", f = "Zip.kt", l = {260}, m = "invokeSuspend")
/* loaded from: classes4.dex */
public final class FlowKt__ZipKt$combineTransform$$inlined$combineTransform$3 extends SuspendLambda implements p<b<? super R>, c<? super kotlin.p>, Object> {
    ...
    /* compiled from: Zip.kt */
    @d(c = "kotlinx.coroutines.flow.FlowKt__ZipKt$combineTransform$$inlined$combineTransform$3$2", f = "Zip.kt", l = {}, m = "invokeSuspend")
    ...
    public static final class AnonymousClass2 extends SuspendLambda implements q<b<? super R>, Object[], c<? super kotlin.p>, Object> {
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            if (this.label == 0) {
                ...
                FlowKt__ZipKt$combineTransform$$inlined$combineTransform$3.this.$transform$inlined.invoke(bVar, objArr[0], objArr[1], objArr[2], objArr[3], objArr[4], this);
                return kotlin.p.a;
            }
    ...
    public FlowKt__ZipKt$combineTransform$$inlined$combineTransform$3(a[] aVarArr, c cVar, u uVar) {
        super(2, cVar);
        this.$flows = aVarArr;
    ...
    public final c<kotlin.p> create(Object obj, c<?> completion) {
        ...
        flowKt__ZipKt$combineTransform$$inlined$combineTransform$3.p$ = (b) obj;
    ...
    public final Object invoke(Object obj, c<? super kotlin.p> cVar) {
        return ((FlowKt__ZipKt$combineTransform$$inlined$combineTransform$3) create(obj, cVar)).invokeSuspend(kotlin.p.a);
    }
