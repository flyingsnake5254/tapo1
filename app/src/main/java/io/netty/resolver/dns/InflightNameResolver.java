        ...
        if (putIfAbsent == null) {
            try {
                ...
                if (promise.isDone()) {
                    ...
                    promise.addListener((GenericFutureListener<? extends Future<? super U>>) new a<U>() { // from class: io.netty.resolver.dns.InflightNameResolver.2
            ...
            putIfAbsent.addListener((GenericFutureListener<? extends Future<? super U>>) new a<U>() { // from class: io.netty.resolver.dns.InflightNameResolver.1
                @Override // io.netty.util.concurrent.GenericFutureListener
                public void operationComplete(Future<U> future) throws Exception {
