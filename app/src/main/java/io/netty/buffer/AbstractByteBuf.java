...
public abstract class AbstractByteBuf extends ByteBuf {
    ...
    static {
        InternalLogger instance = InternalLoggerFactory.getInstance(AbstractByteBuf.class);
        logger = instance;
    ...
    private int firstIndexOf(int i, int i2, byte b2) {
    ...
    private int lastIndexOf(int i, int i2, byte b2) {
    ...
    public int indexOf(int i, int i2, byte b2) {
        if (i <= i2) {
            return firstIndexOf(i, i2, b2);
        }
        return lastIndexOf(i, i2, b2);
    }
    ...
    @Override // io.netty.buffer.ByteBuf
    public ByteBuf setFloat(int i, float f2) {
    ...
    public int ensureWritable(int i, boolean z) {
        ...
        if (i <= maxCapacity - writerIndex) {
            ...
            return 2;
        } else if (!z || capacity() == maxCapacity) {
            return 1;
        } else {
