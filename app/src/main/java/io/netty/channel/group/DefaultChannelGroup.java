...
public class DefaultChannelGroup extends AbstractSet<Channel> implements ChannelGroup {
    ...
    public boolean add(Channel channel) {
        boolean z = (channel instanceof a ? this.serverChannels : this.nonServerChannels).putIfAbsent(channel.id(), channel) == null;
        if (z) {
    ...
    public ChannelGroupFuture write(Object obj, ChannelMatcher channelMatcher, boolean z) {
        ...
        if (z) {
            ...
            channelGroupFuture = new DefaultChannelGroupFuture(this, linkedHashMap, this.executor);
        }
