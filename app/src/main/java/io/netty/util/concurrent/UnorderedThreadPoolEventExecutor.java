...
public final class UnorderedThreadPoolEventExecutor extends ScheduledThreadPoolExecutor implements EventExecutor {
    ...
    /* loaded from: classes3.dex */
    private static final class RunnableScheduledFutureTask<V> extends PromiseTask<V> implements RunnableScheduledFuture<V>, c<V> {
    ...
    public c<?> scheduleAtFixedRate(Runnable runnable, long j, long j2, TimeUnit timeUnit) {
        return (c) super.scheduleAtFixedRate(runnable, j, j2, timeUnit);
    }

    @Override // java.util.concurrent.ScheduledThreadPoolExecutor, java.util.concurrent.ScheduledExecutorService, io.netty.util.concurrent.EventExecutorGroup
    public c<?> scheduleWithFixedDelay(Runnable runnable, long j, long j2, TimeUnit timeUnit) {
        return (c) super.scheduleWithFixedDelay(runnable, j, j2, timeUnit);
    }
    ...
    public c<?> schedule(Runnable runnable, long j, TimeUnit timeUnit) {
        return (c) super.schedule(runnable, j, timeUnit);
    }

    @Override // java.util.concurrent.ScheduledThreadPoolExecutor, java.util.concurrent.ScheduledExecutorService, io.netty.util.concurrent.EventExecutorGroup
    public <V> c<V> schedule(Callable<V> callable, long j, TimeUnit timeUnit) {
        return (c) super.schedule((Callable) callable, j, timeUnit);
    }
