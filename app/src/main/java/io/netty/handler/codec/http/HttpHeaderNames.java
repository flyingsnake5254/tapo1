...
public final class HttpHeaderNames {
    ...
    public static final AsciiString DATE = AsciiString.cached(ColumnFilter.TYPE_DATE);
    ...
    public static final AsciiString FROM = AsciiString.cached(Constants.MessagePayloadKeys.FROM);
    ...
    public static final AsciiString LOCATION = AsciiString.cached(FirebaseAnalytics.Param.LOCATION);
