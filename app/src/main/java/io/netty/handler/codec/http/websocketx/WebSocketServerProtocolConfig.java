...
public final class WebSocketServerProtocolConfig {
    ...
    public static Builder newBuilder() {
        return new Builder(MqttTopic.TOPIC_LEVEL_SEPARATOR, null, false, DEFAULT_HANDSHAKE_TIMEOUT_MILLIS, 0L, true, WebSocketCloseStatus.NORMAL_CLOSURE, true, WebSocketDecoderConfig.DEFAULT);
    }
