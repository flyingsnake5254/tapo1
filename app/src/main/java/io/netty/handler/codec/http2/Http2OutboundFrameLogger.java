...
public class Http2OutboundFrameLogger implements Http2FrameWriter {
    ...
    public ChannelFuture writeFrame(ChannelHandlerContext channelHandlerContext, byte b2, int i, Http2Flags http2Flags, ByteBuf byteBuf, ChannelPromise channelPromise) {
        this.logger.logUnknownFrame(Http2FrameLogger.Direction.OUTBOUND, channelHandlerContext, b2, i, http2Flags, byteBuf);
        return this.writer.writeFrame(channelHandlerContext, b2, i, http2Flags, byteBuf, channelPromise);
    }
