...
public class SpdyHttpDecoder extends MessageToMessageDecoder<a> {
    ...
    protected void decode2(ChannelHandlerContext channelHandlerContext, a aVar, List<Object> list) throws Exception {
        if (aVar instanceof SpdySynStreamFrame) {
            SpdySynStreamFrame spdySynStreamFrame = (SpdySynStreamFrame) aVar;
        ...
        } else if (aVar instanceof SpdySynReplyFrame) {
            SpdySynReplyFrame spdySynReplyFrame = (SpdySynReplyFrame) aVar;
        ...
        } else if (aVar instanceof SpdyHeadersFrame) {
            SpdyHeadersFrame spdyHeadersFrame = (SpdyHeadersFrame) aVar;
        ...
        } else if (aVar instanceof SpdyDataFrame) {
            SpdyDataFrame spdyDataFrame = (SpdyDataFrame) aVar;
        ...
        } else if (aVar instanceof SpdyRstStreamFrame) {
            removeMessage(((SpdyRstStreamFrame) aVar).streamId());
        }
    }
