...
public abstract class ActivityIntrusionScheduleSettingBinding extends ViewDataBinding {
    @NonNull
    ...
    public final TextView f6572c;
    @NonNull

    /* renamed from: d  reason: collision with root package name */
    public final CameraLoadingView f6573d;
    @NonNull
    ...
    public ActivityIntrusionScheduleSettingBinding(Object obj, View view, int i, TextView textView, CameraLoadingView cameraLoadingView, TextView textView2, TextView textView3, TextView textView4, TextView textView5, RecordCustomSettingView recordCustomSettingView, LinearLayout linearLayout, LinearLayout linearLayout2, LinearLayout linearLayout3, AppCompatImageView appCompatImageView, Toolbar toolbar, AppBarLayout appBarLayout) {
        super(obj, view, i);
        this.f6572c = textView;
        this.f6573d = cameraLoadingView;
    ...
    public abstract void i(@Nullable AreaIntrusionScheduleViewModel areaIntrusionScheduleViewModel);
}
