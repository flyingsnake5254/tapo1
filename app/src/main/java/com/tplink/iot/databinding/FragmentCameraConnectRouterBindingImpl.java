...
public class FragmentCameraConnectRouterBindingImpl extends FragmentCameraConnectRouterBinding implements a.AbstractC0211a {
    @Nullable
    ...
    static {
        ...
        sparseIntArray.put(R.id.same_router_tips, 7);
        sparseIntArray.put(R.id.connect_router_iv, 8);
    }

    public FragmentCameraConnectRouterBindingImpl(@Nullable DataBindingComponent dataBindingComponent, @NonNull View view) {
    ...
    public void l(@Nullable CameraConnectRouterViewModel cameraConnectRouterViewModel) {
        this.p1 = cameraConnectRouterViewModel;
    }
    ...
    public boolean setVariable(int i, @Nullable Object obj) {
        if (79 == i) {
            ...
            l((CameraConnectRouterViewModel) obj);
        }
        return true;
    }

    private FragmentCameraConnectRouterBindingImpl(DataBindingComponent dataBindingComponent, View view, Object[] objArr) {
        super(dataBindingComponent, view, 0, (ImageView) objArr[8], (TextView) objArr[6], (RelativeLayout) objArr[4], (TPRefreshableButton) objArr[1], (TextView) objArr[7], (TextView) objArr[5], (Toolbar) objArr[3], (TextView) objArr[2]);
        this.M3 = -1L;
