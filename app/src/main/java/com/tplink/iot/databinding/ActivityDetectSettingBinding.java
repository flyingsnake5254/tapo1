...
public abstract class ActivityDetectSettingBinding extends ViewDataBinding {
    @NonNull
    ...
    @Bindable
    protected DetectionSettingsViewModel M3;
    @Bindable
    ...
    public final LinearLayout f6539c;
    @NonNull

    /* renamed from: d  reason: collision with root package name */
    public final RelativeLayout f6540d;
    @NonNull
    ...
    public ActivityDetectSettingBinding(Object obj, View view, int i, LinearLayout linearLayout, RelativeLayout relativeLayout, TextView textView, TextView textView2, CameraLoadingView cameraLoadingView, LinearLayout linearLayout2, LinearLayout linearLayout3, LinearLayout linearLayout4, LinearLayout linearLayout5, Toolbar toolbar, LinearLayout linearLayout6, CheckBox checkBox, RelativeLayout relativeLayout2, TextView textView3, TextView textView4, TextView textView5) {
        super(obj, view, i);
        this.f6539c = linearLayout;
        this.f6540d = relativeLayout;
    ...
    public abstract void i(@Nullable DetectionSettingsViewModel detectionSettingsViewModel);
}
