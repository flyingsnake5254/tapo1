...
public class FragmentCameraWiredConnectingBindingImpl extends FragmentCameraWiredConnectingBinding implements a.AbstractC0211a {
    @Nullable
    ...
    public FragmentCameraWiredConnectingBindingImpl(@Nullable DataBindingComponent dataBindingComponent, @NonNull View view) {
    ...
    private FragmentCameraWiredConnectingBindingImpl(DataBindingComponent dataBindingComponent, View view, Object[] objArr) {
