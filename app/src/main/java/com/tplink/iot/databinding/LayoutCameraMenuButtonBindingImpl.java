...
public class LayoutCameraMenuButtonBindingImpl extends LayoutCameraMenuButtonBinding {
    @Nullable
    ...
    public LayoutCameraMenuButtonBindingImpl(@Nullable DataBindingComponent dataBindingComponent, @NonNull View view) {
    ...
    protected void executeBindings() {
        ...
        Boolean bool = null;
        ObservableBoolean observableBoolean3 = this.f7210f;
        MutableLiveData<Boolean> mutableLiveData = this.f7209d;
        ...
        if ((j & 47) != 0 && ViewDataBinding.getBuildSdkInt() >= 11) {
            this.f7208c.setAlpha(f2);
        }
        if ((j & 39) != 0) {
            this.f7208c.setEnabled(z8);
        }
        if ((j & 48) != 0) {
            b.Q(this.f7208c, z6);
        }
    ...
    @Override // com.tplink.iot.databinding.LayoutCameraMenuButtonBinding
    ...
    private LayoutCameraMenuButtonBindingImpl(DataBindingComponent dataBindingComponent, View view, Object[] objArr) {
        super(dataBindingComponent, view, 5, (TextView) objArr[1]);
        this.p2 = -1L;
        LinearLayout linearLayout = (LinearLayout) objArr[0];
        this.p1 = linearLayout;
        linearLayout.setTag(null);
        this.f7208c.setTag(null);
        setRootTag(view);
        invalidateAll();
    }
}
