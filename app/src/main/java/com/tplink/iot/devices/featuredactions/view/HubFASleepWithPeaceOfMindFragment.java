...
public final class HubFASleepWithPeaceOfMindFragment extends AbstractFeaturedActionFragment<HubFeaturedActionViewModel> {
    private HashMap K3;
    ...
    public boolean W0(BaseALIoTDevice<?> device) {
        ...
        return x != null && device.isSupportIoTCloud() && s1(x, "open");
    }
    ...
    @Override // com.tplink.iot.devices.featuredactions.view.base.AbstractFeaturedActionFragment
    public int c1() {
        return R.mipmap.scene_sleep_with_peace_of_mind;
    }

    @Override // com.tplink.iot.devices.featuredactions.view.base.AbstractFeaturedActionFragment
    public List<EnumIoTCategory> d1() {
        List<EnumIoTCategory> b2;
        b2 = m.b(EnumIoTCategory.SUBG_TRIGGER_CONTACT_SENSOR);
        return b2;
    }

    @Override // com.tplink.iot.devices.featuredactions.view.base.AbstractFeaturedActionFragment
    public String f1() {
        String string = getString(R.string.scene_sleep_with_peace_of_mind_title);
        j.d(string, "getString(R.string.scene…with_peace_of_mind_title)");
        return string;
    }
    ...
    public SmartInfo[] n1(List<? extends BaseALIoTDevice<?>> selectedDevices) {
        ...
        return new SmartInfo[]{b1().N(f1(), selectedDevices)};
    }
