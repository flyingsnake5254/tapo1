...
public final class MotionSensorFASetAutomaticLightingFragment extends AbstractFeaturedActionFragment<MotionSensorFeaturedActionViewModel> {
    private HashMap K3;
    ...
    @Override // com.tplink.iot.devices.featuredactions.view.base.AbstractFeaturedActionFragment
    public String a1() {
        String string = getString(R.string.scene_set_automatic_lighting_desc);
        j.d(string, "getString(R.string.scene…_automatic_lighting_desc)");
        return string;
    }

    @Override // com.tplink.iot.devices.featuredactions.view.base.AbstractFeaturedActionFragment
    public int c1() {
        return R.mipmap.scene_set_automatic_lighting_t100;
    }
    ...
    @Override // com.tplink.iot.devices.featuredactions.view.base.AbstractFeaturedActionFragment
    public String f1() {
        String string = getString(R.string.scene_set_automatic_lighting_title);
        j.d(string, "getString(R.string.scene…automatic_lighting_title)");
        return string;
    }
