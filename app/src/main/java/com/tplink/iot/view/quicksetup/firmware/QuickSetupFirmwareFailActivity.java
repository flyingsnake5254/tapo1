...
public class QuickSetupFirmwareFailActivity extends BaseActivity implements View.OnClickListener {
    ...
    private void h1() {
        String deviceModel = this.y.getComponentResult().getExtraInfo().getDeviceModel();
        if (c.i(deviceModel)) {
            LightStripPlacementGuideActivity.y.b(this, deviceModel, true, this.y.isFromQuickDiscovery());
        } else {
            Y0();
        }
        finish();
    ...
    private void i1() {
        ...
        ((ImageView) findViewById(R.id.image_device)).setImageResource(com.tplink.iot.view.quicksetup.base.c.W(enumDeviceType, str));
    }
    ...
    public static void k1(Context context, CommonQuickSetupBean commonQuickSetupBean) {
        Intent intent = new Intent(context, QuickSetupFirmwareFailActivity.class);
    ...
    public void onCreate(Bundle bundle) {
        ...
        if (o.a() != 0) {
            setContentView(R.layout.activity_qs_firmware_fail);
            i1();
        }
    }
}
