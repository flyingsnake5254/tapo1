...
public class WifiPrepareCameraActivity extends BaseActivity implements View.OnClickListener {
    ...
    public class a implements View.OnClickListener {
        ...
        public void onClick(View view) {
            if (WifiPrepareCameraActivity.this.J3 != null) {
                WifiPrepareCameraActivity.this.J3.dismiss();
            }
        }
    }
    ...
    public class b implements View.OnClickListener {
        ...
        public void onClick(View view) {
            ...
            WifiPrepareCameraActivity.this.q1();
        }
    }
    ...
    class c implements com.tplink.iot.view.quicksetup.base.wifi.a {
        ...
        public void a() {
            if (!ActivityCompat.shouldShowRequestPermissionRationale(WifiPrepareCameraActivity.this, "android.permission.ACCESS_COARSE_LOCATION") || !ActivityCompat.shouldShowRequestPermissionRationale(WifiPrepareCameraActivity.this, "android.permission.ACCESS_FINE_LOCATION")) {
                WifiPrepareCameraActivity.this.z1();
            }
            f.i();
        }
        ...
        @Override // com.tplink.iot.view.quicksetup.base.wifi.a
        public void b() {
            WifiPrepareCameraActivity.this.u1();
            WifiPrepareCameraActivity.this.m1();
            f.j();
        }
    }
    ...
    public class d implements com.tplink.iot.view.quicksetup.base.broadcast.wifi.a {
        ...
        class a implements Runnable {
            ...
            public void run() {
                if (!WifiPrepareCameraActivity.this.isDestroyed() && !WifiPrepareCameraActivity.this.isFinishing()) {
                    WifiPrepareCameraActivity.this.m1();
                }
            }
        }
        ...
        public void a() {
            WifiPrepareCameraActivity.this.v1(false);
        }

        @Override // com.tplink.iot.view.quicksetup.base.broadcast.wifi.a
        public void b() {
            WifiPrepareCameraActivity.this.v1(true);
            WifiPrepareCameraActivity.this.L3.postDelayed(new a(), 200L);
        }

        @Override // com.tplink.iot.view.quicksetup.base.broadcast.wifi.a
        public void c() {
            WifiPrepareCameraActivity.this.y.setVisibility(8);
            WifiPrepareCameraActivity.this.z.setVisibility(0);
            WifiPrepareCameraActivity.this.z.h();
        }
    }
    ...
    public void onCreate(Bundle bundle) {
        ...
        if (o.a() != 0) {
            setContentView(R.layout.activity_wifi_prepare_camera);
            r1();
        }
    }
    ...
    void z1() {
        ...
        if (tPMaterialDialogV2 == null || !tPMaterialDialogV2.isShowing()) {
            View inflate = LayoutInflater.from(this).inflate(R.layout.layout_camera_wifi_location_permission, (ViewGroup) null, false);
