...
public class CameraCloudConnectSuccessActivity extends BaseActivity implements View.OnClickListener {
    private void e1() {
        setResult(-1);
        finish();
    }
    ...
    public void onCreate(Bundle bundle) {
        ...
        if (o.a() != 0) {
            setContentView(R.layout.activity_camera_cloud_connect_success);
            f1();
        }
    }
}
