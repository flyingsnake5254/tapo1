...
interface zzjn {
    ...
    void zza(int i, zzew zzewVar) throws IOException;

    <K, V> void zza(int i, zzhf<K, V> zzhfVar, Map<K, V> map) throws IOException;

    void zza(int i, Object obj) throws IOException;

    void zza(int i, Object obj, zzib zzibVar) throws IOException;

    void zza(int i, String str) throws IOException;

    void zza(int i, List<String> list) throws IOException;

    void zza(int i, List<?> list, zzib zzibVar) throws IOException;
    ...
    @Deprecated
    void zzb(int i, Object obj, zzib zzibVar) throws IOException;

    void zzb(int i, List<zzew> list) throws IOException;

    @Deprecated
    void zzb(int i, List<?> list, zzib zzibVar) throws IOException;
