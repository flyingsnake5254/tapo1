...
final class zzfa extends zzdu<Integer> implements zzfi<Integer>, zzgu, RandomAccess {
    ...
    @Override // com.google.android.gms.internal.mlkit_common.zzdu, java.util.AbstractCollection, java.util.Collection, java.util.List
    ...
    @Override // com.google.android.gms.internal.mlkit_common.zzdu, java.util.AbstractList, java.util.Collection, java.util.List
    ...
    public final /* synthetic */ zzfi<Integer> zzb(int i) {
        if (i >= this.zzc) {
