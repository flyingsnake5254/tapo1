    ...
    private final zzm zzc(String str) {
        ...
        try {
            ...
            if (packageInfo == null) {
                ...
                zzmVar = (!zza.zzad || (applicationInfo = packageInfo.applicationInfo) == null || (applicationInfo.flags & 2) == 0 || !zzc.zza(str2, zzfVar, false, true).zzad) ? zza : zzm.zzb("debuggable release cert app rejected");
            }
            if (zzmVar.zzad) {
                this.zzan = str;
            }
