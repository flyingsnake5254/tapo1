...
final class zzfy extends zzev<Float> implements zzgl<Float>, zzhx, RandomAccess {
    private static final zzfy zza;
    private float[] zzb;
    private int zzc;

    static {
        zzfy zzfyVar = new zzfy(new float[0], 0);
        zza = zzfyVar;
        zzfyVar.zzb();
    }
    ...
    public final /* synthetic */ zzgl<Float> zza(int i) {
        if (i >= this.zzc) {
            return new zzfy(Arrays.copyOf(this.zzb, i), this.zzc);
        }
        throw new IllegalArgumentException();
    }

    private zzfy(float[] fArr, int i) {
        this.zzb = fArr;
        this.zzc = i;
    }
