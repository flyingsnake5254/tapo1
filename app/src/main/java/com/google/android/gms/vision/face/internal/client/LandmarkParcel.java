...
public final class LandmarkParcel extends AbstractSafeParcelable {
    ...
    @UsedByNative("wrapper.cc")
    public LandmarkParcel(@SafeParcelable.Param(id = 1) int i, @SafeParcelable.Param(id = 2) float f2, @SafeParcelable.Param(id = 3) float f3, @SafeParcelable.Param(id = 4) int i2) {
        this.versionCode = i;
        this.x = f2;
        this.y = f3;
        this.type = i2;
