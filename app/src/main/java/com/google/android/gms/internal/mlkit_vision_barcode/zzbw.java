...
public enum zzbw implements zzgf {
    UNKNOWN_EVENT(0),
    ...
    private static final zzge<zzbw> zzdr = new zzge<zzbw>() { // from class: com.google.android.gms.internal.mlkit_vision_barcode.zzbz
    };
    ...
    public final String toString() {
        return "<" + zzbw.class.getName() + '@' + Integer.toHexString(System.identityHashCode(this)) + " number=" + this.zzds + " name=" + name() + '>';
    }
