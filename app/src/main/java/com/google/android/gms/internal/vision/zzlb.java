...
public final class zzlb implements zzkz {
    ...
    static {
        ...
        zzahg = zzf.zza("OptionalModule__check_alarm_seconds", 10L);
        ...
        zzahs = zzf.zza("OptionalModule__listener_timeout_in_minutes", 5L);
        zzaht = zzf.zza("OptionalModule__max_download_status_pending_count", 5L);
    }
