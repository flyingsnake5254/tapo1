...
public final class zzk {
    ...
    public static long zza(byte[] bArr) {
        ...
        if (length <= 32) {
            ...
            int i8 = 0;
            while (true) {
                long rotateRight2 = (Long.rotateRight(((zzb12 + j5) + jArr[c2]) + zzb(bArr, i8 + 8), i) * (-5435081209227447693L)) ^ jArr2[1];
                ...
                if (i9 == i5) {
                    ...
                    zza(bArr, i7 + 32, jArr2[1] + rotateRight7, zzb(bArr, i7 + 16) + rotateRight6, jArr2);
