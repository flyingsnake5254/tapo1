...
final class zzhw {
    ...
    private static final Class<?> zzd = zzdt.zzb();
    ...
    static final class zzd extends zzc {
        ...
        @Override // com.google.android.gms.internal.mlkit_common.zzhw.zzc
    ...
    static final class zza extends zzc {
        ...
        @Override // com.google.android.gms.internal.mlkit_common.zzhw.zzc
        public final byte zza(Object obj, long j) {
            return zzhw.zza ? zzhw.zzk(obj, j) : zzhw.zzl(obj, j);
        }

        @Override // com.google.android.gms.internal.mlkit_common.zzhw.zzc
        public final boolean zzb(Object obj, long j) {
            return zzhw.zza ? zzhw.zzm(obj, j) : zzhw.zzn(obj, j);
        }
    ...
    private static Field zzf() {
        Field zza2;
        if (zzdt.zza() && (zza2 = zza(Buffer.class, "effectiveDirectAddress")) != null) {
            return zza2;
        }
    ...
    public static Unsafe zzc() {
        try {
            return (Unsafe) AccessController.doPrivileged(new zzhv());
