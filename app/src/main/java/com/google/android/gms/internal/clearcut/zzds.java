...
final class zzds<T> implements zzef<T> {
    ...
    private static int zza(zzef zzefVar, byte[] bArr, int i, int i2, zzay zzayVar) throws IOException {
        ...
        byte b3 = b2;
        if (b2 < 0) {
            i3 = zzax.zza(b2, bArr, i3, zzayVar);
            b3 = zzayVar.zzfd;
        }
        if (b3 < 0 || b3 > i2 - i3) {
            throw zzco.zzbl();
        ...
        int i4 = (b3 == 1 ? 1 : 0) + i3;
        zzefVar.zza(newInstance, bArr, i3, i4, zzayVar);
    ...
    */
    ...
    private final <K, V> int zza(T t, byte[] bArr, int i, int i2, int i3, int i4, long j, zzay zzayVar) throws IOException {
        ...
        while (zza < i6) {
            ...
            int i8 = b2;
            if (b2 < 0) {
                i7 = zzax.zza(b2, bArr, i7, zzayVar);
                i8 = zzayVar.zzfd;
            }
            int i9 = (i8 == 1 ? 1 : 0) >>> 3;
            int i10 = (i8 == 1 ? 1 : 0) & 7;
            if (i9 != 1) {
                if (i9 == 2 && i10 == zzl.zzmd.zzel()) {
                    zza = zza(bArr, i7, i2, zzl.zzmd, zzl.zzdu.getClass(), zzayVar);
                    obj2 = (V) zzayVar.zzff;
                }
                zza = zzax.zza(i8, bArr, i7, i2, zzayVar);
            } else if (i10 == zzl.zzmb.zzel()) {
                zza = zza(bArr, i7, i2, zzl.zzmb, (Class<?>) null, zzayVar);
                obj = (K) zzayVar.zzff;
            } else {
                zza = zzax.zza(i8, bArr, i7, i2, zzayVar);
            }
    ...
    private final boolean zza(T t, int i) {
        if (this.zzmq) {
            ...
            switch ((zzag & 267386880) >>> 20) {
                case 0:
                    return zzfd.zzn(t, j) != Utils.DOUBLE_EPSILON;
                case 1:
    ...
    */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:221:0x0414, code lost:
        if (zza((com.google.android.gms.internal.clearcut.zzds<T>) r20, r15, r5) != false) goto L_0x06b6;
     */
    /* JADX WARN: Code restructure failed: missing block: B:229:0x0434, code lost:
        if (zza((com.google.android.gms.internal.clearcut.zzds<T>) r20, r15, r5) != false) goto L_0x06e3;
     */
    /* JADX WARN: Code restructure failed: missing block: B:231:0x043c, code lost:
        if (zza((com.google.android.gms.internal.clearcut.zzds<T>) r20, r15, r5) != false) goto L_0x06ee;
     */
    /* JADX WARN: Code restructure failed: missing block: B:239:0x045c, code lost:
        if (zza((com.google.android.gms.internal.clearcut.zzds<T>) r20, r15, r5) != false) goto L_0x0713;
     */
    /* JADX WARN: Code restructure failed: missing block: B:241:0x0464, code lost:
        if (zza((com.google.android.gms.internal.clearcut.zzds<T>) r20, r15, r5) != false) goto L_0x0722;
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:247:0x047c, code lost:
        if (zza((com.google.android.gms.internal.clearcut.zzds<T>) r20, r15, r5) != false) goto L_0x0749;
     */
