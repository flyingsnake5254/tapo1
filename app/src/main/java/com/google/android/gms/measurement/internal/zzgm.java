...
public final class zzgm extends zzec {
    ...
    public final List<zzkq> zzi(zzp zzpVar, boolean z) {
        ...
        try {
            ...
            this.zza.zzau().zzb().zzc("Failed to get user properties. appId", zzem.zzl(zzpVar.zza), e2);
            return null;
        }
    }
    ...
    public final byte[] zzj(zzas zzasVar, String str) {
        ...
        try {
            ...
            this.zza.zzau().zzb().zzd("Failed to log and bundle. appId, event, error", zzem.zzl(str), this.zza.zzo().zzc(zzasVar.zza), e2);
            return null;
        }
    }
    ...
    public final List<zzkq> zzo(String str, String str2, boolean z, zzp zzpVar) {
        ...
        try {
            ...
            this.zza.zzau().zzb().zzc("Failed to query user properties. appId", zzem.zzl(zzpVar.zza), e2);
    ...
    public final List<zzkq> zzp(String str, String str2, String str3, boolean z) {
        ...
        try {
            ...
            this.zza.zzau().zzb().zzc("Failed to get user properties as. appId", zzem.zzl(str), e2);
            return Collections.emptyList();
        }
    }
    ...
    public final List<zzaa> zzq(String str, String str2, zzp zzpVar) {
        ...
        try {
            ...
            this.zza.zzau().zzb().zzb("Failed to get conditional user properties", e2);
            return Collections.emptyList();
        }
    }
    ...
    public final List<zzaa> zzr(String str, String str2, String str3) {
        ...
        try {
            ...
            this.zza.zzau().zzb().zzb("Failed to get conditional user properties as", e2);
            return Collections.emptyList();
        }
    }
