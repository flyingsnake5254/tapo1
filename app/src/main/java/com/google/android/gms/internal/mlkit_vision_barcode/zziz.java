...
final class zziz {
    ...
    private static final Class<?> zzd = zzeu.zzb();
    ...
    static final class zzd extends zzc {
        ...
        @Override // com.google.android.gms.internal.mlkit_vision_barcode.zziz.zzc
    ...
    static final class zza extends zzc {
        ...
        @Override // com.google.android.gms.internal.mlkit_vision_barcode.zziz.zzc
        public final byte zza(Object obj, long j) {
            return zziz.zza ? zziz.zzk(obj, j) : zziz.zzl(obj, j);
        }

        @Override // com.google.android.gms.internal.mlkit_vision_barcode.zziz.zzc
        public final boolean zzb(Object obj, long j) {
            return zziz.zza ? zziz.zzm(obj, j) : zziz.zzn(obj, j);
        }
    ...
    private static Field zzf() {
        Field zza2;
        if (zzeu.zza() && (zza2 = zza(Buffer.class, "effectiveDirectAddress")) != null) {
            return zza2;
        }
    ...
    public static Unsafe zzc() {
        try {
            return (Unsafe) AccessController.doPrivileged(new zziy());
