...
public final class FadeProvider implements VisibilityAnimatorProvider {
    ...
    private static Animator createFadeAnimator(final View view, final float f2, final float f3, @FloatRange(from = 0.0d, to = 1.0d) final float f4, @FloatRange(from = 0.0d, to = 1.0d) final float f5) {
