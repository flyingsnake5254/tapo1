...
public class PlayerView extends FrameLayout implements e0 {
    ...
    private boolean J3;
    @Nullable
    private PlayerControlView.d K3;
    private boolean L3;
    @Nullable
    private Drawable M3;
    private int N3;
    ...
    private final AspectRatioFrameLayout f3683d;
    @Nullable

    /* renamed from: f  reason: collision with root package name */
    private final View f3684f;
    @Nullable
    private final View p0;
    @Nullable
    private final TextView p1;
    @Nullable
    private final PlayerControlView p2;
    @Nullable
    ...
    /* loaded from: classes.dex */
    public final class a implements u1.e, View.OnLayoutChangeListener, View.OnClickListener, PlayerControlView.d {

        /* renamed from: c  reason: collision with root package name */
        private final j2.b f3685c = new j2.b();
        @Nullable

        /* renamed from: d  reason: collision with root package name */
        private Object f3686d;
        ...
        public void B(List<c> list) {
            if (PlayerView.this.z != null) {
                PlayerView.this.z.B(list);
            }
        }

        @Override // com.google.android.exoplayer2.u1.c
        public void G(TrackGroupArray trackGroupArray, k kVar) {
            u1 u1Var = (u1) g.e(PlayerView.this.I3);
            j2 w = u1Var.w();
            if (w.q()) {
                this.f3686d = null;
            } else if (!u1Var.u().c()) {
                this.f3686d = w.g(u1Var.H(), this.f3685c, true).f2329c;
            } else {
                Object obj = this.f3686d;
                if (obj != null) {
                    int b2 = w.b(obj);
                    if (b2 != -1) {
                        if (u1Var.m() == w.f(b2, this.f3685c).f2330d) {
                            return;
                        }
                    }
                    this.f3686d = null;
        ...
        public void e(u1.f fVar, u1.f fVar2, int i) {
            if (PlayerView.this.w() && PlayerView.this.T3) {
                PlayerView.this.u();
            }
        }
        ...
        public void onLayoutChange(View view, int i, int i2, int i3, int i4, int i5, int i6, int i7, int i8) {
            PlayerView.o((TextureView) view, PlayerView.this.V3);
        }
        ...
        @Override // com.google.android.exoplayer2.video.w
        public void z() {
            if (PlayerView.this.f3684f != null) {
                PlayerView.this.f3684f.setVisibility(4);
            }
        }
    }
    ...
    private boolean A(@Nullable Drawable drawable) {
        if (drawable != null) {
            ...
            if (intrinsicWidth > 0 && intrinsicHeight > 0) {
                y(this.f3683d, intrinsicWidth / intrinsicHeight);
    ...
    private boolean C() {
        ...
        return this.S3 && (playbackState == 1 || playbackState == 4 || !this.I3.E());
    }
    ...
    public void G() {
        ...
        if (view instanceof TextureView) {
            ...
            if (this.V3 != 0) {
                view.removeOnLayoutChangeListener(this.f3682c);
            }
            this.V3 = i3;
            if (i3 != 0) {
                this.q.addOnLayoutChangeListener(this.f3682c);
            }
            o((TextureView) this.q, this.V3);
        }
        AspectRatioFrameLayout aspectRatioFrameLayout = this.f3683d;
        if (!this.x) {
        }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void I() {
        PlayerControlView playerControlView = this.p2;
        String str = null;
    ...
    private void x(boolean z) {
        if ((!w() || !this.T3) && N()) {
            boolean z2 = this.p2.I() && this.p2.getShowTimeoutMs() <= 0;
            boolean C = C();
            if (z || z2 || C) {
                E(C);
            }
    ...
    public int getResizeMode() {
        g.i(this.f3683d);
        return this.f3683d.getResizeMode();
    }
    ...
    public boolean s(KeyEvent keyEvent) {
        return N() && this.p2.A(keyEvent);
    }

    public void setAspectRatioListener(@Nullable AspectRatioFrameLayout.b bVar) {
        g.i(this.f3683d);
        this.f3683d.setAspectRatioListener(bVar);
    }
    ...
    public void setControllerVisibilityListener(@Nullable PlayerControlView.d dVar) {
        g.i(this.p2);
        PlayerControlView.d dVar2 = this.K3;
        if (dVar2 != dVar) {
            if (dVar2 != null) {
                this.p2.K(dVar2);
            }
    ...
    public PlayerView(Context context, @Nullable AttributeSet attributeSet, int i) {
        ...
        int i8 = p0.exo_player_view;
        if (attributeSet != null) {
            TypedArray obtainStyledAttributes = context.getTheme().obtainStyledAttributes(attributeSet, t0.PlayerView, 0, 0);
            try {
                int i9 = t0.PlayerView_shutter_background_color;
                z3 = obtainStyledAttributes.hasValue(i9);
                int color = obtainStyledAttributes.getColor(i9, 0);
                i8 = obtainStyledAttributes.getResourceId(t0.PlayerView_player_layout_id, i8);
                z2 = obtainStyledAttributes.getBoolean(t0.PlayerView_use_artwork, true);
                int resourceId = obtainStyledAttributes.getResourceId(t0.PlayerView_default_artwork, 0);
                z = obtainStyledAttributes.getBoolean(t0.PlayerView_use_controller, true);
                i4 = obtainStyledAttributes.getInt(t0.PlayerView_surface_type, 1);
                i6 = obtainStyledAttributes.getInt(t0.PlayerView_resize_mode, 0);
                int i10 = obtainStyledAttributes.getInt(t0.PlayerView_show_timeout, DisconnectedBufferOptions.DISCONNECTED_BUFFER_SIZE_DEFAULT);
                boolean z8 = obtainStyledAttributes.getBoolean(t0.PlayerView_hide_on_touch, true);
                z6 = obtainStyledAttributes.getBoolean(t0.PlayerView_auto_show, true);
                i5 = obtainStyledAttributes.getInteger(t0.PlayerView_show_buffering, 0);
                this.O3 = obtainStyledAttributes.getBoolean(t0.PlayerView_keep_content_on_player_reset, this.O3);
                boolean z9 = obtainStyledAttributes.getBoolean(t0.PlayerView_hide_during_ads, true);
        ...
        if (playerControlView != null) {
            this.p2 = playerControlView;
        } else if (findViewById3 != null) {
            PlayerControlView playerControlView2 = new PlayerControlView(context, null, 0, attributeSet);
            this.p2 = playerControlView2;
        ...
        PlayerControlView playerControlView3 = this.p2;
        ...
        this.S3 = z6;
        this.T3 = z5;
        this.J3 = z && playerControlView3 != null;
        u();
        I();
        PlayerControlView playerControlView4 = this.p2;
