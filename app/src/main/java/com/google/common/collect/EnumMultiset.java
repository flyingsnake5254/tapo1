...
public final class EnumMultiset<E extends Enum<E>> extends i<E> implements Serializable {
    ...
    public class b extends EnumMultiset<E>.c<u1.a<E>> {
        ...
        public class a extends v1.b<E> {
            ...
            /* renamed from: b */
            public E a() {
                return (E) EnumMultiset.this.enumConstants[this.f4173c];
            }

            @Override // com.google.common.collect.u1.a
            public int getCount() {
                return EnumMultiset.this.counts[this.f4173c];
            }
        }
    ...
    abstract class c<T> implements Iterator<T> {
        ...
        public boolean hasNext() {
            while (this.f4175c < EnumMultiset.this.enumConstants.length) {
        ...
        public void remove() {
            v.e(this.f4176d >= 0);
            if (EnumMultiset.this.counts[this.f4176d] > 0) {
                EnumMultiset.access$210(EnumMultiset.this);
                EnumMultiset.this.size -= EnumMultiset.this.counts[this.f4176d];
                EnumMultiset.this.counts[this.f4176d] = 0;
            }
            this.f4176d = -1;
        }
    }
