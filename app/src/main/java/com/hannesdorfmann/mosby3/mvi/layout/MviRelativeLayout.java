...
public abstract class MviRelativeLayout<V extends b, P extends d<V, ?>> extends RelativeLayout implements b, i<V, P> {

    /* renamed from: c  reason: collision with root package name */
    private boolean f5087c = false;

    /* renamed from: d  reason: collision with root package name */
    protected h<V, P> f5088d;
    ...
    protected h<V, P> getMvpDelegate() {
        if (this.f5088d == null) {
            this.f5088d = new j(this, this, true);
        }
        return this.f5088d;
    }
