    ...
    */
    private static android.graphics.Typeface loadFont(@androidx.annotation.NonNull android.content.Context r15, android.content.res.Resources r16, android.util.TypedValue r17, int r18, int r19, @androidx.annotation.Nullable androidx.core.content.res.ResourcesCompat.FontCallback r20, @androidx.annotation.Nullable android.os.Handler r21, boolean r22) {
        ...
        L_0x0031:
            return r1
        L_0x0032:
            java.lang.String r1 = r12.toLowerCase()     // Catch: IOException -> 0x0076, XmlPullParserException -> 0x008c
            java.lang.String r2 = ".xml"
            boolean r1 = r1.endsWith(r2)     // Catch: IOException -> 0x0076, XmlPullParserException -> 0x008c
            if (r1 == 0) goto L_0x0065
            android.content.res.XmlResourceParser r1 = r0.getXml(r4)     // Catch: IOException -> 0x0076, XmlPullParserException -> 0x008c
            androidx.core.content.res.FontResourcesParserCompat$FamilyResourceEntry r2 = androidx.core.content.res.FontResourcesParserCompat.parse(r1, r0)     // Catch: IOException -> 0x0076, XmlPullParserException -> 0x008c
            if (r2 != 0) goto L_0x0053
            java.lang.String r0 = "Failed to find font-family tag"
            android.util.Log.e(r11, r0)     // Catch: IOException -> 0x0076, XmlPullParserException -> 0x008c
            if (r9 == 0) goto L_0x0052
            r9.callbackFailAsync(r14, r10)     // Catch: IOException -> 0x0076, XmlPullParserException -> 0x008c
        L_0x0052:
            return r13
        L_0x0053:
            r1 = r15
            ...
            r7 = r21
            r8 = r22
            android.graphics.Typeface r0 = androidx.core.graphics.TypefaceCompat.createFromResourcesFamilyXml(r1, r2, r3, r4, r5, r6, r7, r8)     // Catch: IOException -> 0x0076, XmlPullParserException -> 0x008c
            return r0
        L_0x0065:
            r1 = r15
            android.graphics.Typeface r0 = androidx.core.graphics.TypefaceCompat.createFromResourcesFontFile(r15, r0, r4, r12, r5)     // Catch: IOException -> 0x0076, XmlPullParserException -> 0x008c
            if (r9 == 0) goto L_0x0075
            if (r0 == 0) goto L_0x0072
            r9.callbackSuccessAsync(r0, r10)     // Catch: IOException -> 0x0076, XmlPullParserException -> 0x008c
            goto L_0x0075
        L_0x0072:
            r9.callbackFailAsync(r14, r10)     // Catch: IOException -> 0x0076, XmlPullParserException -> 0x008c
        L_0x0075:
