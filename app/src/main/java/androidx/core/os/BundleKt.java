        ...
        for (Pair<String, ? extends Object> pair : pairs) {
            ...
            if (component2 == null) {
                ...
                if (Parcelable.class.isAssignableFrom(componentType)) {
                    ...
                    throw new IllegalArgumentException("Illegal value array type " + componentType.getCanonicalName() + " for key \"" + component1 + StringUtil.DOUBLE_QUOTE);
                }
                ...
                if (i >= 18 && (component2 instanceof IBinder)) {
                    ...
                    throw new IllegalArgumentException("Illegal value type " + component2.getClass().getCanonicalName() + " for key \"" + component1 + StringUtil.DOUBLE_QUOTE);
                } else {
