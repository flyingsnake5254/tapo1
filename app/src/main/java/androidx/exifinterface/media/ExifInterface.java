...
public class ExifInterface {
    ...
    private static final byte[] PNG_SIGNATURE = {-119, 80, 78, 71, 13, 10, BinaryMemcacheOpcodes.PREPENDQ, 10};
    ...
    public static class ExifAttribute {
        ...
        /* JADX WARN: Not initialized variable reg: 3, insn: 0x01a0: MOVE  (r2 I:??[OBJECT, ARRAY]) = (r3 I:??[OBJECT, ARRAY]), block:B:137:0x01a0 */
        /* JADX WARN: Removed duplicated region for block: B:154:0x01a3 A[EXC_TOP_SPLITTER, SYNTHETIC] */
        /*
    ...
    private static double convertRationalLatLonToDouble(String str, String str2) {
        try {
            String[] split = str.split(SSLClient.COMMA, -1);
    ...
    /* JADX WARN: Code restructure failed: missing block: B:67:0x019e, code lost:
        return;
     */
    /* JADX WARN: Removed duplicated region for block: B:33:0x00c2 A[FALL_THROUGH] */
    /* JADX WARN: Removed duplicated region for block: B:57:0x0178  */
    /* JADX WARN: Removed duplicated region for block: B:80:0x018d A[SYNTHETIC] */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    ...
    private static Pair<Integer, Integer> guessDataFormat(String str) {
        if (str.contains(SSLClient.COMMA)) {
            String[] split = str.split(SSLClient.COMMA, -1);
    ...
    */
    ...
    public Bitmap getThumbnailBitmap() {
        ...
        if (i == 1) {
            ...
            for (int i2 = 0; i2 < length; i2++) {
                ...
                int i3 = i2 * 3;
                iArr[i2] = (bArr[i3] << BinaryMemcacheOpcodes.STAT) + 0 + (bArr[i3 + 1] << 8) + bArr[i3 + 2];
            }
    ...
    /* JADX WARN: Removed duplicated region for block: B:38:0x0064 A[Catch: Exception -> 0x0097, all -> 0x00b4, TRY_ENTER, TRY_LEAVE, TryCatch #0 {all -> 0x00b4, blocks: (B:38:0x0064, B:41:0x0074, B:43:0x0080, B:48:0x008b, B:49:0x0090, B:50:0x0091, B:51:0x0096, B:54:0x0099, B:55:0x009e, B:60:0x00a6), top: B:71:0x000a }] */
    /* JADX WARN: Removed duplicated region for block: B:54:0x0099 A[Catch: Exception -> 0x0097, all -> 0x00b4, TryCatch #0 {all -> 0x00b4, blocks: (B:38:0x0064, B:41:0x0074, B:43:0x0080, B:48:0x008b, B:49:0x0090, B:50:0x0091, B:51:0x0096, B:54:0x0099, B:55:0x009e, B:60:0x00a6), top: B:71:0x000a }] */
    ...
    */
    ...
    /* JADX WARN: Removed duplicated region for block: B:41:0x00b8 A[Catch: all -> 0x0110, Exception -> 0x0113, TryCatch #11 {Exception -> 0x0113, all -> 0x0110, blocks: (B:39:0x00af, B:41:0x00b8, B:42:0x00c0, B:44:0x00c4, B:46:0x00c8, B:48:0x00d6), top: B:102:0x00af }] */
    /* JADX WARN: Removed duplicated region for block: B:42:0x00c0 A[Catch: all -> 0x0110, Exception -> 0x0113, TryCatch #11 {Exception -> 0x0113, all -> 0x0110, blocks: (B:39:0x00af, B:41:0x00b8, B:42:0x00c0, B:44:0x00c4, B:46:0x00c8, B:48:0x00d6), top: B:102:0x00af }] */
    /* JADX WARN: Removed duplicated region for block: B:52:0x00e5 A[Catch: all -> 0x0104, Exception -> 0x0106, TryCatch #13 {Exception -> 0x0106, all -> 0x0104, blocks: (B:50:0x00e0, B:52:0x00e5, B:55:0x00ed, B:58:0x00f5), top: B:99:0x00e0 }] */
    ...
    */
    ...
    public void setAltitude(double d2) {
        String str = d2 >= Utils.DOUBLE_EPSILON ? "0" : "1";
    ...
    public void setAttribute(@NonNull String str, @Nullable String str2) {
        ...
        boolean equals = TAG_ISO_SPEED_RATINGS.equals(str3);
        String str5 = TAG;
        if (equals) {
            if (DEBUG) {
                Log.d(str5, "setAttribute: Replacing TAG_ISO_SPEED_RATINGS with TAG_PHOTOGRAPHIC_SENSITIVITY.");
            }
        ...
        if (str4 != null && sTagSetForCompatibility.contains(str3)) {
            if (str3.equals(TAG_GPS_TIMESTAMP)) {
                if (!sGpsTimestampPattern.matcher(str4).find()) {
                    Log.w(str5, "Invalid value for " + str3 + " : " + str4);
                    return;
                }
            ...
            if ((i4 != 4 || this.mHasThumbnail) && (exifTag = sExifTagMapsForWriting[i4].get(str3)) != null) {
                if (str4 == null) {
                    ...
                    if (exifTag.primaryFormat == ((Integer) guessDataFormat.first).intValue() || exifTag.primaryFormat == ((Integer) guessDataFormat.second).intValue()) {
                        ...
                        if (i6 == -1 || !(i6 == ((Integer) guessDataFormat.first).intValue() || exifTag.secondaryFormat == ((Integer) guessDataFormat.second).intValue())) {
                            ...
                            if (i7 == i3 || i7 == 7 || i7 == i2) {
                                ...
                                String str6 = "";
                                sb.append(exifTag.secondaryFormat == -1 ? str6 : ", " + strArr[exifTag.secondaryFormat]);
                                sb.append(" (guess: ");
                    ...
                    switch (i) {
                        ...
                        case 3:
                            str5 = str5;
                            String[] split = str4.split(SSLClient.COMMA, -1);
                        ...
                        case 4:
                            str5 = str5;
                            String[] split2 = str4.split(SSLClient.COMMA, -1);
                        ...
                        case 5:
                            str5 = str5;
                            String[] split3 = str4.split(SSLClient.COMMA, -1);
                            Rational[] rationalArr = new Rational[split3.length];
                            int i10 = 0;
                            while (i10 < split3.length) {
                                String[] split4 = split3[i10].split(MqttTopic.TOPIC_LEVEL_SEPARATOR, i5);
                        ...
                        case 9:
                            str5 = str5;
                            String[] split5 = str4.split(SSLClient.COMMA, -1);
                            ...
                            break;
                        case 10:
                            String[] split6 = str4.split(SSLClient.COMMA, -1);
                            Rational[] rationalArr2 = new Rational[split6.length];
                            int i12 = 0;
                            while (i12 < split6.length) {
                                String[] split7 = split6[i12].split(MqttTopic.TOPIC_LEVEL_SEPARATOR, -1);
                            ...
                            break;
                        case 12:
                            String[] split8 = str4.split(SSLClient.COMMA, -1);
    ...
    public void setLatLong(double d2, double d3) {
        if (d2 < -90.0d || d2 > 90.0d || Double.isNaN(d2)) {
            ...
            setAttribute(TAG_GPS_LATITUDE_REF, d2 >= Utils.DOUBLE_EPSILON ? "N" : LATITUDE_SOUTH);
            setAttribute(TAG_GPS_LATITUDE, convertDecimalDegree(Math.abs(d2)));
            setAttribute(TAG_GPS_LONGITUDE_REF, d3 >= Utils.DOUBLE_EPSILON ? LONGITUDE_EAST : LONGITUDE_WEST);
    ...
    private ExifInterface(@NonNull InputStream inputStream, boolean z) throws IOException {
        ExifTag[][] exifTagArr = EXIF_TAGS;
        this.mAttributes = new HashMap[exifTagArr.length];
        this.mAttributesOffsets = new HashSet(exifTagArr.length);
        this.mExifByteOrder = ByteOrder.BIG_ENDIAN;
