...
public class SwipeRefreshLayout extends ViewGroup implements NestedScrollingParent, NestedScrollingChild {
    ...
    public void onMeasure(int i, int i2) {
        ...
        if (view != null) {
            ...
            this.mCircleView.measure(View.MeasureSpec.makeMeasureSpec(this.mCircleDiameter, Pow2.MAX_POW2), View.MeasureSpec.makeMeasureSpec(this.mCircleDiameter, Pow2.MAX_POW2));
