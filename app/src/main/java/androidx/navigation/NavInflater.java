            ...
            if (fromArgType == navType) {
                ...
                if (i4 != 0) {
                    ...
                    if (i5 == 3) {
                        ...
                        fromArgType = checkNavType(typedValue, fromArgType, NavType.FloatType, string, ColumnFilter.TYPE_FLOAT);
                        obj = Float.valueOf(typedValue.getFloat());
                    } else if (i5 == 5) {
                        fromArgType = checkNavType(typedValue, fromArgType, NavType.IntType, string, "dimension");
                        obj = Integer.valueOf((int) typedValue.getDimension(resources.getDisplayMetrics()));
                    } else if (i5 == 18) {
                        fromArgType = checkNavType(typedValue, fromArgType, NavType.BoolType, string, ColumnFilter.TYPE_BOOLEAN);
                        ...
                        fromArgType = checkNavType(typedValue, fromArgType, NavType.IntType, string, ColumnFilter.TYPE_INTEGER);
