...
public class ViewDragHelper {
    ...
    private int computeSettleDuration(View view, int i, int i2, int i3, int i4) {
        ...
        return (int) ((computeAxisDuration(i, clampMag, this.mCallback.getViewHorizontalDragRange(view)) * f6) + (computeAxisDuration(i2, clampMag2, this.mCallback.getViewVerticalDragRange(view)) * (f5 / f4)));
    }
