...
public class SlidingPaneLayout extends ViewGroup {
    ...
    */
    ...
    protected void onMeasure(int i, int i2) {
        ...
        while (true) {
            ...
            if (childAt.getVisibility() == 8) {
                ...
                if (i15 == -2) {
                    i9 = View.MeasureSpec.makeMeasureSpec(paddingLeft - i14, Integer.MIN_VALUE);
                    f2 = f2;
                    ...
                    i10 = Integer.MIN_VALUE;
                    if (i15 == -1) {
                        i9 = View.MeasureSpec.makeMeasureSpec(paddingLeft - i14, Pow2.MAX_POW2);
                    } else {
                        i9 = View.MeasureSpec.makeMeasureSpec(i15, Pow2.MAX_POW2);
                    }
                }
                int i16 = ((ViewGroup.MarginLayoutParams) layoutParams).height;
                if (i16 == -2) {
                    i11 = View.MeasureSpec.makeMeasureSpec(i3, i10);
                } else if (i16 == -1) {
                    i11 = View.MeasureSpec.makeMeasureSpec(i3, Pow2.MAX_POW2);
                } else {
                    i11 = View.MeasureSpec.makeMeasureSpec(i16, Pow2.MAX_POW2);
                }
                childAt.measure(i9, i11);
                int measuredWidth = childAt.getMeasuredWidth();
                int measuredHeight = childAt.getMeasuredHeight();
                if (mode2 == i10 && measuredHeight > i4) {
                            ...
                            if (layoutParams2.weight > 0.0f) {
                                if (((ViewGroup.MarginLayoutParams) layoutParams2).width == 0) {
                                    ...
                                    if (i19 == -2) {
                                        ...
                                        i6 = View.MeasureSpec.makeMeasureSpec(i3, Pow2.MAX_POW2);
                                    } else {
                                        i6 = View.MeasureSpec.makeMeasureSpec(i19, Pow2.MAX_POW2);
                                    }
                                } else {
                                    i6 = View.MeasureSpec.makeMeasureSpec(childAt2.getMeasuredHeight(), Pow2.MAX_POW2);
                                }
                                if (z2) {
                                    ...
                                    i17 = i17;
                                    int makeMeasureSpec = View.MeasureSpec.makeMeasureSpec(i20, Pow2.MAX_POW2);
                                    ...
                                    i17 = i17;
                                    childAt2.measure(View.MeasureSpec.makeMeasureSpec(measuredWidth2 + ((int) ((layoutParams2.weight * Math.max(0, i12)) / f2)), Pow2.MAX_POW2), i6);
                                    i18++;
                                    i5 = 8;
                                }
                            }
                        } else if (((ViewGroup.MarginLayoutParams) layoutParams2).width < 0 && (measuredWidth2 > i17 || layoutParams2.weight > 0.0f)) {
                            if (z4) {
                                ...
                                if (i21 == -2) {
                                    ...
                                    i7 = Pow2.MAX_POW2;
                                    i8 = View.MeasureSpec.makeMeasureSpec(i3, Pow2.MAX_POW2);
                                } else {
                                    i7 = Pow2.MAX_POW2;
                                    i8 = View.MeasureSpec.makeMeasureSpec(i21, Pow2.MAX_POW2);
                                }
                            } else {
                                i7 = Pow2.MAX_POW2;
                                i8 = View.MeasureSpec.makeMeasureSpec(childAt2.getMeasuredHeight(), Pow2.MAX_POW2);
                            }
                            childAt2.measure(View.MeasureSpec.makeMeasureSpec(i17, i7), i8);
                        }
                    }
                }
                i17 = i17;
    ...
    boolean smoothSlideTo(float f2, int i) {
        ...
        LayoutParams layoutParams = (LayoutParams) this.mSlideableView.getLayoutParams();
        if (isLayoutRtlSupport) {
            i2 = (int) (getWidth() - (((getPaddingRight() + ((ViewGroup.MarginLayoutParams) layoutParams).rightMargin) + (f2 * this.mSlideRange)) + this.mSlideableView.getWidth()));
        } else {
            i2 = (int) (getPaddingLeft() + ((ViewGroup.MarginLayoutParams) layoutParams).leftMargin + (f2 * this.mSlideRange));
        }
