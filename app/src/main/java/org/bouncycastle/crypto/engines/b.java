...
public class b implements c {
    ...
    private void e(int[] iArr, int[] iArr2, int i) {
        ...
        iArr[0] = iArr[0] ^ i12;
        iArr[1] = (i12 ^ m(i10, 8)) ^ iArr[1];
    }

    private void f(int[] iArr, int[] iArr2, int i) {
        iArr[1] = iArr[1] ^ j(iArr[0] & iArr2[i + 0], 1);
        iArr[0] = iArr[0] ^ (iArr2[i + 1] | iArr[1]);
        iArr[2] = iArr[2] ^ (iArr2[i + 3] | iArr[3]);
        iArr[3] = j(iArr2[i + 2] & iArr[2], 1) ^ iArr[3];
    }

    private static void g(int i, int[] iArr, int i2, int[] iArr2, int i3) {
        int i4 = i3 + 2;
        int i5 = i2 + 0;
        int i6 = i2 + 1;
        int i7 = 32 - i;
    ...
    private int k(byte[] bArr, int i, byte[] bArr2, int i2) {
        for (int i3 = 0; i3 < 4; i3++) {
            this.k[i3] = c(bArr, (i3 * 4) + i);
            int[] iArr = this.k;
            iArr[i3] = iArr[i3] ^ this.i[i3];
        }
        e(this.k, this.h, 0);
        e(this.k, this.h, 4);
        e(this.k, this.h, 8);
        ...
        i(iArr2[2], bArr2, i2);
        i(this.k[3], bArr2, i2 + 4);
        i(this.k[0], bArr2, i2 + 8);
        i(this.k[1], bArr2, i2 + 12);
        return 16;
    }

    private int l(byte[] bArr, int i, byte[] bArr2, int i2) {
        for (int i3 = 0; i3 < 4; i3++) {
            this.k[i3] = c(bArr, (i3 * 4) + i);
            int[] iArr = this.k;
            iArr[i3] = iArr[i3] ^ this.i[i3];
    ...
    private static void n(int i, int[] iArr, int i2, int[] iArr2, int i3) {
        int i4 = i3 + 0;
        int i5 = i2 + 0;
        int i6 = i2 + 1;
        int i7 = 32 - i;
    ...
    private static void o(int i, int[] iArr, int i2, int[] iArr2, int i3) {
        int i4 = i3 + 0;
        int i5 = i2 + 1;
        int i6 = i - 32;
        int i7 = i2 + 2;
    ...
    private void p(boolean z, byte[] bArr) {
        int[] iArr = new int[8];
        int[] iArr2 = new int[4];
        int[] iArr3 = new int[4];
        int[] iArr4 = new int[4];
        ...
        if (this.g) {
            ...
            if (z) {
                ...
                iArr5[2] = iArr[2];
                iArr5[3] = iArr[3];
                n(15, iArr, 0, this.h, 4);
                n(30, iArr, 0, this.h, 12);
                n(15, iArr, 0, iArr4, 0);
                int[] iArr6 = this.h;
                iArr6[18] = iArr4[2];
                iArr6[19] = iArr4[3];
                n(17, iArr, 0, this.j, 4);
                n(17, iArr, 0, this.h, 24);
                n(17, iArr, 0, this.h, 32);
                int[] iArr7 = this.h;
                iArr7[0] = iArr2[0];
                iArr7[1] = iArr2[1];
                iArr7[2] = iArr2[2];
                iArr7[3] = iArr2[3];
                n(15, iArr2, 0, iArr7, 8);
                n(15, iArr2, 0, this.j, 0);
                n(15, iArr2, 0, iArr4, 0);
                int[] iArr8 = this.h;
                iArr8[16] = iArr4[0];
                iArr8[17] = iArr4[1];
                n(15, iArr2, 0, iArr8, 20);
                o(34, iArr2, 0, this.h, 28);
                n(17, iArr2, 0, this.i, 4);
                return;
            }
            iArr5[4] = iArr[0];
            iArr5[5] = iArr[1];
            iArr5[6] = iArr[2];
            iArr5[7] = iArr[3];
            g(15, iArr, 0, this.h, 28);
            g(30, iArr, 0, this.h, 20);
            g(15, iArr, 0, iArr4, 0);
            int[] iArr9 = this.h;
            iArr9[16] = iArr4[0];
            iArr9[17] = iArr4[1];
            g(17, iArr, 0, this.j, 0);
            g(17, iArr, 0, this.h, 8);
            g(17, iArr, 0, this.h, 0);
            int[] iArr10 = this.h;
            iArr10[34] = iArr2[0];
            iArr10[35] = iArr2[1];
            iArr10[32] = iArr2[2];
            iArr10[33] = iArr2[3];
            g(15, iArr2, 0, iArr10, 24);
            g(15, iArr2, 0, this.j, 4);
            g(15, iArr2, 0, iArr4, 0);
            int[] iArr11 = this.h;
            iArr11[18] = iArr4[2];
            iArr11[19] = iArr4[3];
            g(15, iArr2, 0, iArr11, 12);
            h(34, iArr2, 0, this.h, 4);
            n(17, iArr2, 0, this.i, 0);
            return;
        }
        for (int i3 = 0; i3 < 4; i3++) {
        ...
        if (z) {
            ...
            iArr12[2] = iArr[2];
            iArr12[3] = iArr[3];
            o(45, iArr, 0, this.h, 16);
            n(15, iArr, 0, this.j, 4);
            n(17, iArr, 0, this.h, 32);
            o(34, iArr, 0, this.h, 44);
            n(15, iArr, 4, this.h, 4);
            n(15, iArr, 4, this.j, 0);
            n(30, iArr, 4, this.h, 24);
            o(34, iArr, 4, this.h, 36);
            n(15, iArr2, 0, this.h, 8);
            n(30, iArr2, 0, this.h, 20);
            int[] iArr13 = this.j;
            iArr13[8] = iArr2[1];
            iArr13[9] = iArr2[2];
            iArr13[10] = iArr2[3];
            iArr13[11] = iArr2[0];
            o(49, iArr2, 0, this.h, 40);
            int[] iArr14 = this.h;
            iArr14[0] = iArr3[0];
            iArr14[1] = iArr3[1];
            iArr14[2] = iArr3[2];
            iArr14[3] = iArr3[3];
            n(30, iArr3, 0, iArr14, 12);
            n(30, iArr3, 0, this.h, 28);
            o(51, iArr3, 0, this.i, 4);
            return;
        }
        iArr12[4] = iArr[0];
        iArr12[5] = iArr[1];
        iArr12[6] = iArr[2];
        iArr12[7] = iArr[3];
        h(45, iArr, 0, this.h, 28);
        g(15, iArr, 0, this.j, 4);
        g(17, iArr, 0, this.h, 12);
        h(34, iArr, 0, this.h, 0);
        g(15, iArr, 4, this.h, 40);
        g(15, iArr, 4, this.j, 8);
        g(30, iArr, 4, this.h, 20);
        h(34, iArr, 4, this.h, 8);
        g(15, iArr2, 0, this.h, 36);
        g(30, iArr2, 0, this.h, 24);
        int[] iArr15 = this.j;
        iArr15[2] = iArr2[1];
        iArr15[3] = iArr2[2];
        iArr15[0] = iArr2[3];
        iArr15[1] = iArr2[0];
        h(49, iArr2, 0, this.h, 4);
        int[] iArr16 = this.h;
        iArr16[46] = iArr3[0];
        iArr16[47] = iArr3[1];
        iArr16[44] = iArr3[2];
        iArr16[45] = iArr3[3];
        g(30, iArr3, 0, iArr16, 32);
        g(30, iArr3, 0, this.h, 16);
        o(51, iArr3, 0, this.i, 0);
    }
    ...
    public int d(byte[] bArr, int i, byte[] bArr2, int i2) throws DataLengthException, IllegalStateException {
        if (!this.f17076f) {
            ...
            return this.g ? k(bArr, i, bArr2, i2) : l(bArr, i, bArr2, i2);
        } else {
