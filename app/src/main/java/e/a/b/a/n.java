...
class n implements Cloneable {
    ...
    public n(long[] jArr, int i, int i2) {
    ...
    private static n F(long[] jArr, int i, int i2, int i3, int[] iArr) {
        return new n(jArr, i, E(jArr, i, i2, i3, iArr));
    }
    ...
    private static void G(long[] jArr, int i, int i2, int i3, int i4, int[] iArr) {
        ...
        while (true) {
            length--;
            if (length >= 0) {
                o(jArr, i, jArr, i + i3, i2 - i3, i5 + iArr[length]);
            } else {
                o(jArr, i, jArr, i + i3, i2 - i3, i5);
                return;
            }
        }
    }
    ...
    private void e(n nVar, int i, int i2) {
        int i3 = (i + 63) >>> 6;
        int i4 = i2 >>> 6;
        int i5 = i2 & 63;
        if (i5 == 0) {
            a(this.z, i4, nVar.z, 0, i3);
            return;
        }
        long h = h(this.z, i4, nVar.z, 0, i3, i5);
        if (h != 0) {
            long[] jArr = this.z;
            int i6 = i3 + i4;
            jArr[i6] = h ^ jArr[i6];
    ...
    private static long g(long[] jArr, int i, long[] jArr2, int i2, int i3, int i4) {
        int i5 = 64 - i4;
        long j = 0;
        while (true) {
            i3--;
    ...
    private static void n(long[] jArr, int i, int i2) {
        int i3 = i + (i2 >>> 6);
        jArr[i3] = jArr[i3] ^ (1 << (i2 & 63));
    }

    private static void o(long[] jArr, int i, long[] jArr2, int i2, int i3, int i4) {
        int i5 = i + (i4 >>> 6);
        int i6 = i4 & 63;
        if (i6 == 0) {
            a(jArr, i5, jArr2, i2, i3);
        } else {
            jArr[i5] = g(jArr, i5 + 1, jArr2, i2, i3, 64 - i6) ^ jArr[i5];
        }
    }

    private static void p(long[] jArr, int i, int i2, long j) {
        int i3 = i + (i2 >>> 6);
        int i4 = i2 & 63;
        if (i4 == 0) {
            jArr[i3] = jArr[i3] ^ j;
    ...
    public String toString() {
        ...
        int i = q2 - 1;
        StringBuffer stringBuffer = new StringBuffer(Long.toBinaryString(this.z[i]));
        while (true) {
            i--;
            if (i < 0) {
                return stringBuffer.toString();
            }
            String binaryString = Long.toBinaryString(this.z[i]);
    ...
    public n v(int i, int[] iArr) {
        ...
        if (l != 0) {
            ...
            while (true) {
                ...
                int i8 = 1 - i2;
                nVarArr[i2].e(nVarArr[i8], iArr2[i8], i6);
                int m = nVarArr[i2].m(i4);
                if (m == 0) {
                    return nVarArr2[i8];
                }
                int i9 = iArr3[i8];
                nVarArr2[i2].e(nVarArr2[i8], i9, i6);
                int i10 = i9 + i6;
                if (i10 > i5) {
                    i5 = i10;
                } else if (i10 == i5) {
    ...
    public n w(n nVar, int i, int[] iArr) {
        int i2;
        int i3;
        n nVar2;
        n nVar3;
        ...
        if (i4 == 1) {
            ...
            A(j, nVar3.z, i5, jArr, 0);
            return F(jArr, 0, i6, i, iArr);
        }
        int i7 = ((i2 + 7) + 63) >>> 6;
        ...
        iArr2[1] = i7;
        System.arraycopy(nVar3.z, 0, jArr2, i7, i5);
        int i9 = 2;
        int i10 = i7;
        for (int i11 = 16; i9 < i11; i11 = 16) {
            ...
            if ((i9 & 1) == 0) {
                jArr2 = jArr2;
                i8 = i8;
                K(jArr2, i10 >>> 1, jArr2, i10, i7, 1);
            } else {
                jArr2 = jArr2;
                i8 = i8;
                b(jArr2, i7, jArr2, i10 - i7, jArr2, i10, i7);
            }
            i9++;
        }
        long[] jArr3 = new long[i8];
        K(jArr2, 0, jArr3, 0, i8, 4);
        long[] jArr4 = nVar2.z;
        int i12 = i6 << 3;
        ...
        while (i13 < i4) {
            ...
            while (true) {
                long j3 = j2 >>> 4;
                c(jArr5, i14, jArr2, iArr2[((int) j2) & 15], jArr3, iArr2[((int) j3) & 15], i7);
                j2 = j3 >>> 4;
                if (j2 == 0) {
                    break;
                }
        ...
        while (true) {
            i12 -= i6;
            if (i12 == 0) {
                return F(jArr5, 0, i6, i, iArr);
            }
            h(jArr5, i12 - i6, jArr5, i12, i6, 8);
        }
    }

    public n x(int i, int[] iArr) {
        int q2 = q();
        if (q2 == 0) {
            return this;
        }
        ...
        return new n(jArr, 0, E(jArr, 0, i2, i, iArr));
    }

    public n y(int i, int i2, int[] iArr) {
        int q2 = q();
        if (q2 == 0) {
            return this;
        }
        ...
        System.arraycopy(this.z, 0, jArr, 0, q2);
        while (true) {
            i--;
            if (i < 0) {
                return new n(jArr, 0, q2);
            }
            M(jArr, q2, i2, iArr);
            q2 = E(jArr, 0, i3, i2, iArr);
        }
    }

    public n z(n nVar, int i, int[] iArr) {
        int i2;
        int i3;
        n nVar2;
        n nVar3;
